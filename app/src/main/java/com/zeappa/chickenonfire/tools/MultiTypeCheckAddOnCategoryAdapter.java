...
import com.zeappa.chickenonfire.AddOnItem;
...
public class MultiTypeCheckAddOnCategoryAdapter extends MultiTypeExpandableRecyclerViewAdapter<AddOnCategoryViewHolder, ChildViewHolder>
    ...
    private LinkedHashMap<String, List<AddOnItem>> selectedAddOns;
    ...
    public LinkedHashMap<String, List<AddOnItem>> getSelectedAddOns() {
            ...
            case IS_MULTIPLE:
                ...
                ((MultiCheckAddOnItemViewHolder) holder).setOnChildCheckedListener(new OnChildCheckChangedListener() {
                    ...
                    public void onChildCheckChanged(View view, boolean checked, int flatPos) {
                        ...
                        if(selectedAddOns.get(addOnItem.getType()) != null){
                            if(selectedAddOns.get(addOnItem.getType()).size() == addOnItem.getChooseMax() && checked){
                        ...
                        if(checked){
                            ...
                            List<AddOnItem> listItems = selectedAddOns.get(addOnItem.getType());
                            for(int i = 0; i < listItems.size(); i++){
                                if(listItems.get(i).getAid() == addOnItem.getAid()){
                                    listItems.remove(i);
                                    selectedAddOns.put(addOnItem.getType(),listItems);
                                    return;
                                }
                            }
                        }
                    ...
                    public void onChildCheckChanged(View view, boolean checked, int flatPos) {
                        ...
                        if(checked){
                            ...
                            if(selectedAddOns.get(addOnItem.getType()) == null){
                                ...
                                totalPrice -= selectedAddOns.get(addOnItem.getType()).get(0).getPrice() * Integer.parseInt(quantityText.getText().toString());
    ...
    private synchronized void addToList(String mapKey, AddOnItem myItem) {
