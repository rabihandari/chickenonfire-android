...
public class AddOnItem implements Parcelable {
    ...
    AddOnItem(int aid ,int cid, String name,String nameAr, double price, String type, int isOptional, int isMultiple,String instruction,int chooseMin, int chooseMax) {
        this.aid = aid;
        this.cid = cid;
        this.name = name;
        this.nameAr = nameAr;
